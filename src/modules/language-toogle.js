...
function setLanguageButton(language, languageLinks) {
  languageLinks.innerHTML = `
        <img class="topbar__language_link rus${
          language === 'ru' ? ' language_active' : ''
        }" src="/images/icons/rus.svg" alt="Трехцветный флаг России">
        <img class="topbar__language_link eng${
          language === 'en' ? ' language_active' : ''
        }" src="/images/icons/usa.svg" alt="Звездно-полосатый флаг США">
    `;
}
